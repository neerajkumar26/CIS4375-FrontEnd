...
export default {
    ...
    methods: {
        ...
        async fetchCustomOrderHistory() {
            try {
                const response = await fetch('https://coogtech-backend.vercel.app/adminData/CustomOrders', {
                    method: 'GET',
                    credentials: 'include', // Use 'include' to send cookies with the request
                    headers: {
        ...
        async fetchOrderHistory() {
            try {
                const response = await fetch('https://coogtech-backend.vercel.app/adminData/Orders', {
                    method: 'GET',
                    credentials: 'include', // Use 'include' to send cookies with the request
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('access-token')}`,
